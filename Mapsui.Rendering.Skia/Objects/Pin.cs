...
namespace Mapsui.Rendering.Skia.Objects;
...
public class Pin : IPin
{
    ...
    public Pin(IMapControl mapView)
    {
        _mapView = mapView;
    ...
    public IMapControl? MapView
    {
        ...
        set
        {
            if (_mapView != value)
            {
                if (_callout != null)
                {
                    _mapView?.Map?.RemoveCallout(_callout);
                }
    ...
    public void ShowCallout()
    {
        ...
        {
            _callout.Update();
            _mapView?.Map?.AddCallout(_callout);
        }
    }
    ...
    {
        return _mapView != null && _callout != null && _mapView.Map != null && _mapView.Map.IsCalloutVisible(_callout);
    }
                ...
                case PinType.Pin:
                    ...
                    using (var bitmap = new SKBitmap(info))
                    {
                        ...
                        using (var paint = new SKPaint() { IsAntialias = true })
                        {
                            ...
                            paint.ColorFilter = SKColorFilter.CreateBlendMode(Color.ToSkia(), SKBlendMode.SrcIn); // use the source color
                            canvas.Clear();
