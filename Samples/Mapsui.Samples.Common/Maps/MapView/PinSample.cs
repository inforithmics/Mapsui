        ...
        switch (mapClickedArgs.NumOfTaps)
        {
            case 1:
                var pin = new Pin(mapView)
                {
                    ...
                    Type = PinType.Pin,
                    Color = new Color(
                        Convert.ToInt32(_random.Next(0, 256) / 256.0f),
                        Convert.ToInt32(_random.Next(0, 256) / 256.0f),
                        Convert.ToInt32(_random.Next(0, 256) / 256.0f)),
                    Transparency = 0.5f,
                ...
                pin.Callout.Padding = new Thickness(_random.Next(0, 20), _random.Next(0, 20), _random.Next(0, 20), _random.Next(0, 20));
                ...
                if (_random.Next(0, 3) < 2)
                {
                    ...
                    pin.Callout.TitleFontColor = new Color(Convert.ToInt32(_random.Next(0, 256) / 256.0f),
                        Convert.ToInt32(_random.Next(0, 256) / 256.0f),
                        Convert.ToInt32(_random.Next(0, 256) / 256.0f));
