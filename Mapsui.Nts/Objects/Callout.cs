...
public class Callout : IFeatureProvider, IDisposable, INotifyPropertyChanged
{
    ...
    public static TextAlignment DefaultSubtitleTextAlignment = TextAlignment.Left; // Center;
    ...
    private Thickness _padding = new Thickness(6, 6, 6, 6);
    ...
    private void UpdateContent()
    {
        ...
        style.TitleTextAlignment = TitleTextAlignment;
        ...
        style.SubtitleFontColor = SubtitleFontColor;
        style.SubtitleTextAlignment = SubtitleTextAlignment;
